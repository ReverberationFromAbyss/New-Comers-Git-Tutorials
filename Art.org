...
There is no problem for students who came from countries other than China to download the setup utilities for git on Windows.
However, if you do have the request to download through mirror site, you may visit [[https://mirrors.tuna.tsinghua.edu.cn/github-release/git-for-windows/git/][tsinghua university open source software mirror]]
